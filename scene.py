...
class Scene(element.Element):
    def __init__(self, bground: sprite.Sprite) -> None:
        ...
        self.all_listeners: Optional[dict[int, dict[Callable[[pygame.event.Event, dict[str, Any]], None], dict[str, Any]]]] = None
    ...
    def get_all_listeners(self) -> None:
        listeners: dict[int, dict[Callable[[pygame.event.Event, dict[str, Any]], None], dict[str, Any]]] = self.listeners

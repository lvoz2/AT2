...
class UI_Element:
    def __init__(self, design: surf_rect.Surf_Rect | str, x: int, y: int, font: Optional[pygame.font.Font] = None, anti_alias: Optional[bool] = None, fcolour: Optional[Sequence[int]] = None, bcolour: Optional[Sequence[int]] = None, center: bool = False, rect: Optional[pygame.Rect] = None, scale: int = 1) -> None:
    ...
    def draw(self, window: pygame.Surface) -> None:
        if self.center:
            ...
            self.design.rect = window.blit(self.design.surf, self.design.surf.get_rect(center=[self.x, self.y]), self.rect)
